...
%orig;
if ([[objc_getClass("SpringBoard") sharedApplication] isShowingHomescreen]){

LAEvent *homeScreenEvent = [LAEvent eventWithName:@"com.kaneb.homescreenopen" mode:[LASharedActivator currentEventMode]];
[LASharedActivator sendEventToListener:homeScreenEvent];

}else {

LAEvent *appEvent = [LAEvent eventWithName:@"com.kaneb.appopen" mode:[LASharedActivator currentEventMode]];
...
LAEvent *incomingCallEvent = [LAEvent eventWithName:@"com.kaneb.incomingcall" mode:[LASharedActivator currentEventMode]];
[LASharedActivator sendEventToListener:incomingCallEvent];
}else if ([[objc_getClass("SBLockScreenManager") sharedInstance]isLockScreenVisible]){

LAEvent *lockScreenEvent = [LAEvent eventWithName:@"com.kaneb.lockscreenopen" mode:[LASharedActivator currentEventMode]];
[LASharedActivator sendEventToListener:lockScreenEvent];


}else if ([[%c(SBUIController) sharedInstance] isAppSwitcherShowing]){

LAEvent *appSwitcherEvent = [LAEvent eventWithName:@"com.kaneb.appswitcheropen" mode:[LASharedActivator currentEventMode]];
...
///registering events
///app
[LASharedActivator registerEventDataSource:self forEventName: appGeneric];

///homescreen
[LASharedActivator registerEventDataSource:self forEventName: homescreen];

//appSwitcher
[LASharedActivator registerEventDataSource:self forEventName: appSwitcher];

///lockscreen
[LASharedActivator registerEventDataSource:self forEventName: lockscreen];

///incoming call
[LASharedActivator registerEventDataSource:self forEventName: incomingCall];
